...
league_name = "KBLux Liga 4B"  # Name of your league, must be exact match, can be done via env or hardcoded
start_budget = 150_000_000               # Starting budget of your league, used to calculate current budgets of other managers
league_start_date = "2025-07-29"        # Start date of your league, used to filter activities, format: YYYY-MM-DD
